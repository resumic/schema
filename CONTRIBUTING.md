...
Thank you for your interest in contributing to Resumic.  
This guide helps make contributing to Resumic simple and efficient for everyone.

### First contribution

If you are starting out contributing to Resumic, there might be smaller scoped "starter issues" available:
[Current starter issues](https://github.com/resumic/schema/labels/starter%20issue)
...
As your time is precious and not all features might be in the scope of what the Resumic wants to achieve, please open up an issue first.
